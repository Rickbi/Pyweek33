...
class Map:
    def __init__(self, width, height, nx, ny) -> None:
        ...
        self.t1 = time.time()
        self.block_select = 0
        self.block_type = [(0,0,0), (255,0,0), (0,255,0), (0,0,255), (255,255,255), (255,0,255)]
    ...
    def make_level(self):
        ...
        for y, line in enumerate(self.lvl):
            for x, value in enumerate(line):
                if value == 2:
                    self.player.add(Sprite(self.nx, self.ny, x, y, 2, movable = [0,4], color = (255,0,0)))
                elif value == 3:
                    self.twin.add(Sprite(self.nx, self.ny, x, y, 3, movable = [0,5], color = (100,255,100)))
                elif value == 4:
                    self.player_door.add(Sprite(self.nx, self.ny, x, y, 4, color = (255,255,255)))
                elif value == 5:
                    self.twin_door.add(Sprite(self.nx, self.ny, x, y, 5, color = (255,0,255)))
    ...
    def check_if_won(self):
        cond_1 = self.player.sprites()[0].pos_grid == self.player_door.sprites()[0].pos_grid
        cond_2 = self.twin.sprites()[0].pos_grid == self.twin_door.sprites()[0].pos_grid
    ...
    def main_menu(self):
        ...
        buttons = [Button('Play', self.width//2, 100),
                   Button('Quit Game', self.width//2, 250)]
